...
const Footer = () => (
  <footer className="bg-card border-t border-border py-12">
    <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
      ...
      <div>
        <h4 className="font-display text-xl font-semibold text-foreground mb-4">Follow Us</h4>
        <div className="flex flex-col gap-3">
          <a
            href="https://www.tiktok.com/@paintsurgeon"
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted-foreground hover:text-primary transition-colors text-sm font-body flex items-center gap-2"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="text-muted-foreground hover:text-[hsl(142,70%,45%)] transition-colors text-sm font-body flex items-center gap-2"
          >
            <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
